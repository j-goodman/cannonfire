              ...
              case 'line':
                if (number === 1) {
                  ...
                  return [
                    ...
                    this.capitalize(this.number(number)) + " of " + (playerAttack ? "their" : "our") + " men are killed in " + (playerAttack ? "our" : "their") + " volley. They lay dead in rows as they lived a moment ago.",
                  ][Math.floor(Math.random() * 3)];
                }
                break;
              case 'bayonets':
                if (number === 1) {
                  return [
                    ...
                    "One of " + (playerAttack ? "their" : "our") + " infantry has his thigh run through with a bayonet.",
                  ...
                  return [
                    ...
                    this.number(number) + " of " + (playerAttack ? "their" : "our") + "men are stabbed to death.",
                  ][0];
                }
                break;
              }
            ...
            switch (attackingUnit.formation) {
              ...
              case 'line':
                if (number === 1) {
                  ...
                  return [
                    (playerAttack ? "Our" : "Their") + " infantry " + attackingUnit.formation + " rains rifle fire across at " + (playerAttack ? "their" : "our") + " artillery, disabling " + this.number(number) + " of our guns.",
                  ][0];
                }
                break;
              case 'bayonets':
        ...
        // CAVALRY ATTACKS INFANTRY
          switch (attackingUnit.disposition) {
            ...
            case 'sabers':
              if (number === 1) {
                return [
                  "A " + attacker.adjective() + " cavalryman charges past one of the " + defender.adjective() + " infantrymen and reaches down to cut his throat with his saber as he charges.",
                ...
                return [
                  ...
                  ) + "as they charge " + (playerAttack ? "their" : "our") + " infantry, finally clashing and knocking " + this.number(number) + " men bleeding to the ground under hoofs and steel."
                ][0];
              }
              break;
            }
        ...
        // CAVALRY ATTACKS CAVALRY
          switch (attackingUnit.disposition) {
            ...
            case 'sabers':
              if (number === 1) {
                return [
                  "Two cavalrymen lock their sabers in deadly combat, circling each other on their chargers until the " + attacker.adjective() + " man ends it by plunging his blade through his enemy's chest where it meets the neck.",
                  "Two cavalrymen lock their sabers in deadly combat, circling each other on their chargers until the " + attacker.adjective() + " man ends it by stabbing his enemy in the thigh and releasing a geyser of blood as the wounded man tumbles out of his saddle.",
                ][Math.floor(Math.random() * 2)];
              } else if (number > 0) {
                return [
                  (playerAttack ? "Their" : "Our") + " horses keep their resolve as the " + attacker.adjective() + " cavalry approaches, then finally they reach their target, slashing and stabbing at their enemies and killing " + this.number(number) + " of " + (playerAttack ? "our" : "their") + " horsemen.",
                ][0];
              }
              break;
            }
    ...
    case 'artillery':
      switch (killedUnit.type) {
        ...
        case 'cavalry':
          if (number === 1) {
            return [
              "A cannonball hurls down across the " + battlefield.biome + " and splits a " + defender.adjective() + " horse into two pieces at the midsection, mangling its rider.",
