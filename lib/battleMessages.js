            ...
            case 'sabers':
              if (number === 1) {
                ...
                return [
                  ...
                  ) + "as they charge our infantry, finally clashing and knocking " + this.number(number) + " men bleeding to the ground under hoofs and steel."
                ][0];
              }
              break;
            }
          ...
          switch (attackingUnit.disposition) {
            ...
            case 'sabers':
              if (number === 1) {
                ...
                return [
                  (playerAttack ? "Their" : "Our") + " horses keep their resolve as the " + attacker.adjective() + " cavalry approaches, then finally they reach their target, slashing and stabbing at their enemies and killing " + this.number(number) + " of " + (playerAttack ? "their" : "our") + " horsemen.",
                ][0];
              }
              break;
            }
