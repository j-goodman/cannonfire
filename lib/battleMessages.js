            ...
            switch (attackingUnit.formation) {
              case 'column' || 'line':
                if (number === 1) {
                  ...
                  return [
                    (playerAttack ? "Our" : "Their") + " infantry " + attacker.formation + " rains across at " + (playerAttack ? "their" : "our") + " artillery, disabling " + this.number(number) + " of our guns.",
                  ][0];
                }
                break;
              case 'bayonets':
              ...
              if (number === 1) {
                ...
                return [
                  "The " + attacker.adjective() + " cavalry " + (
                    ...
                    " kick up an enormous plume of desert dust behind them " :
          ...
          switch (attackingUnit.formation) {
            ...
            case 'sabers':
              if (number === 1) {
                ...
                return [
                  (playerAttack ? "Their" : "Our") + " horses keep their resolve as the " + attacker.adjective() + " cavalry approaches, then finally they reach their target, slashing and stabbing at their enemies and killing " + this.number(number) + " of " + defender.adjective() + "horsemen.",
                ][0];
              }
              break;
            }
          ...
          switch (attackingUnit.formation) {
            case 'rifles':
              if (number === 1) {
                ...
                return [
                  (playerAttack ? "Our" : "Their") + " cavalry " + attacker.formation + " rains across at " + (playerAttack ? "their" : "our") + " artillery, disabling " + this.number(number) + " of our guns.",
                ][Math.floor(Math.random() * 2)];
              }
              break;
            case 'sabers':
              if (number === 1) {
                return [
                  "A " + attacker.adjective() + " horseman slashes the throat of one of the " + defender.adjective() + " artillery officer and rears his horse up, kicking " + (playerAttack ? "their" : "our") + " cannon out of its housing.",
                ][0];
              } else {
                return [
    ...
    case 'artillery':
      switch (killedUnit.type) {
        ...
        case 'infantry':
          if (number === 1) {
            return [
              ...
              "A cannonball rips across the battlefield and striks a " + defender.adjective() + " horse directly in the head, crumpling it in on itself as its rider soars forward onto the battlefield and lands with a crack.",
        ...
        case 'infantry':
          if (number === 1) {
            return [
              "A cannonball hurltles down across the " + battlefield.biome + " and drives an enormous crack down the length of a " + defender.adjective() + " gun and causing it to explode.",
            ][0];
          } else {
            return [
