...
var createCloneArmies = function () {
  ...
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Utah', 'French Empire', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('Texas', 'United States of America', Math.round(Math.random() * 11));
  }
