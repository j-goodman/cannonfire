...
var createPlayerArmy = function () {
  game.armies = [];
  game.playerArmy = new Army ('California', null, 6, true);
...
var createCloneArmies = function () {
  ...
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Utah', 'Confederate States of America', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('Texas', 'Confederate States of America', Math.round(Math.random() * 11));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Louisiana', 'French Empire', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('British Columbia', 'British Empire', Math.round(Math.random() * 11));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Manitoba', 'Coalition of Freedmen', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('Coahuila', 'United Mexican States', Math.round(Math.random() * 11));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('New Mexico', 'United Mexican States', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('Nevada', 'United States of America', Math.round(Math.random() * 11));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Nunavut', 'British Empire', Math.round(Math.random() * 11));
  } else {
    newArmy = new Army ('Alaska', 'French Empire', Math.round(Math.random() * 11));
  }
  game.armies.push(newArmy);
};
