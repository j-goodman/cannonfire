...
var createPlayerArmy = function () {
  game.armies = [];
  game.playerArmy = new Army (Object.keys(MAP)[Math.floor(Math.random() * Object.keys(MAP).length)], null, 7, true);
...
var createCloneArmies = function () {
  ...
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Utah', 'French Empire', Math.round(Math.random() * 10));
  } else {
    newArmy = new Army ('Texas', 'United States of America', Math.round(Math.random() * 10));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Louisiana', 'French Empire', Math.round(Math.random() * 10));
  } else {
    newArmy = new Army ('British Columbia', 'British Empire', Math.round(Math.random() * 10));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Manitoba', 'Coalition of Freedmen', Math.round(Math.random() * 13));
  } else {
    newArmy = new Army ('Coahuila', 'United Mexican States', Math.round(Math.random() * 13));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('New Mexico', 'United Mexican States', Math.round(Math.random() * 14));
  } else {
    newArmy = new Army ('Washington', 'United States of America', Math.round(Math.random() * 14));
  }
  game.armies.push(newArmy);
  if (!Math.round(Math.random())) {
    newArmy = new Army ('Nunavut', 'British Empire', Math.round(Math.random() * 16));
  } else {
    newArmy = new Army ('Alaska', 'French Empire', Math.round(Math.random() * 16));
  }
  game.armies.push(newArmy);
};
