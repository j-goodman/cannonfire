...
var MAP = {
  ...
  'Northwest Territories': new Territory ({
    ...
    nation: 'UK',
    biome: 'arctic',
    borderNames: ['Yukon', 'Nunavut', 'British Columbia', 'Alberta', 'Saskatchewan'],
  }),
  ...
  'Manitoba': new Territory ({
    ...
    nation: 'UK',
    biome: 'taiga',
    borderNames: ['Saskatchewan', 'Nunavut', 'North Dakota', 'Minnesota'],
  }),
  ...
  'Coahuila': new Territory ({
    ...
    nation: 'Mexico',
    biome: 'mountains',
    borderNames: ['Chihuahua', 'Texas', 'Nuevo Leon', 'Tamaulipas', 'Zacatecas', 'Durango'],
  }),
