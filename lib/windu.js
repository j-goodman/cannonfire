...
var checkOverflow = function (windu, expander) {
  ...
  if (windu.scrollWidth > windu.clientWidth || windu.scrollHeight > windu.clientHeight) {
    ...
    windu.style.borderBottom = '1px dotted #4b4';
  } else {
    expander.className = '';
    expander.style.background = '#000';
    expander.style.border = '2px solid #4b4';
    expander.style.color = '#4b4';
    windu.style.borderBottom = '2px solid #4b4';
    windu.style.borderRight = '2px solid #4b4';
  }
  if (windu.scrollWidth > windu.clientWidth && windu.scrollHeight <= windu.clientHeight) {
    expander.innerText = '▶';
    windu.style.borderBottom = '2px solid #4b4';
    windu.style.borderRight = '1px dotted #4b4';
  } else {
    expander.innerText = '▼';
  }
};
