...
var updateTroopsWindow = function () {
  ...
  infantryCount.innerText = 'INFANTRY: ' + game.playerArmy.infantry.count;
  ...
  cavalryCount.innerText = 'CAVALRY: ' + game.playerArmy.cavalry.count;
  ...
  artilleryCount.innerText = 'ARTILLERY: ' + game.playerArmy.artillery.count;
  ...
  for (i=0 ; i<windows.length ; i++) {
    ...
    switch (windu.id) {
      ...
      case 'Commands':
        ...
        break;
      case 'Troops':
        windu.style.left = perX(1030);
        windu.style.top = perY(288);
        windu.style.width = perX(262);
        windu.style.height = perY(226);
        break;
      case 'Supply':
        windu.style.left = perX(732);
        windu.style.top = perY(472);
        windu.style.width = perX(516);
